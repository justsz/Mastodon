...
import mastodon.app.gui.*;
//import mastodon.app.mapper.application.MapperFrame;
//import mastodon.trace.TraceList;
...
public class MapperPanel extends JPanel implements Exportable {
	...
	/* (non-Javadoc)
	 * @see jam.framework.Exportable#getExportableComponent()
	 */
	@Override
