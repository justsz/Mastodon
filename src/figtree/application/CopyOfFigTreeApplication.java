...
public class CopyOfFigTreeApplication extends MultiDocApplication {

    public static final String VERSION = "1.3.1";
    public static final String DATES = "2006-2009";

    public static CopyOfFigTreeApplication application;

    public CopyOfFigTreeApplication(MenuBarFactory menuBarFactory, String nameString, String aboutString, Icon icon,
...
//		        g = new JPEGGraphics2D(file, new Dimension(width, height));
    ...
    static public void main(String[] args) {
        ...
        java.net.URL url = CopyOfFigTreeApplication.class.getResource("images/figtreeLogo.png");
        Icon icon = null;
        ...
        CopyOfFigTreeApplication.application = new CopyOfFigTreeApplication(new FigTreeMenuBarFactory(), nameString, aboutString, icon,
