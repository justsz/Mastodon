...
public class FigTreeFrame extends DocumentFrame implements FigTreeFileMenuHandler, TreeMenuHandler {
    ...
    public void initializeComponents() {
        ...
        Icon pruningToolIcon = IconUtils.getIcon(this.getClass(), "images/scissors.png");
        final ToolbarAction pruningToolbarAction = new ToolbarAction("Prune", "Prune selection", pruningToolIcon) {
            public void actionPerformed(ActionEvent e){
                pruningAction.actionPerformed(e);
            }
        };
        ToolbarButton pruningToolButton = new ToolbarButton(pruningToolbarAction, true);
        pruningToolButton.setFocusable(false);
        toolBar.addComponent(pruningToolButton);
...
//        figTreePanel.showUtilityPanel(panel);
    ...
    private AbstractAction pruningAction = new AbstractAction(COLOUR) {
        public void actionPerformed(ActionEvent ae) {
            pruneSelected();
        }
    };
    ...
    private void pruneSelected() {
        treeViewer.annotateSelected("pruned", 1.0);
        setDirty();
    }
